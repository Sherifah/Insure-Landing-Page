  ...
  return (
    <div className='bg-primary-100 px-32 py-16 text-white relative'>
      <div className='w-1/2 pr-8 pb-10'>
          ...
          <div className=''>
            <div className='font-headings text-6xl pb-8 leading-18'>
            ...
            <div className='bg-primary-100 px-8 py-2 font-body font-bold text-sm border-2 text-white border-white hover:text-primary-100 hover:bg-white max-w-[9.5rem] cursor-pointer'>
        ...
        <img src='images/bg-pattern-intro-left-desktop.svg' alt='patterns' className='absolute left-0 -bottom-48 w-[8.5rem]' />
    </div>
  )
}
